    ...
    <div className="relative flex items-center justify-center">
      ...
      >
        <motion.div
          ...
          whileTap={
            isSaved ? (animations.icon as any).tapCompleted : (animations.icon as any).tapActive
          }
          ...
          <motion.div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            {[...Array(5)].map((_, i) => (
              <motion.div
                ...
                initial={(animations.particles(i) as any).initial}
                animate={(animations.particles(i) as any).animate}
                transition={(animations.particles(i) as any).transition}
              />
            ))}
          </motion.div>
        )}
