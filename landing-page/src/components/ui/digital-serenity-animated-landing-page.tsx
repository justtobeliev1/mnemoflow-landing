          ...
          <div className="text-center max-w-5xl mx-auto relative">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extralight leading-tight tracking-tight text-slate-50 text-decoration-animate">
              <div className="mb-4 md:mb-6">
                <span className="word-animate" data-delay="700">Cognitive</span>
                <span className="word-animate" data-delay="850">Science</span>
                <span className="word-animate" data-delay="1000">Driven</span>
              </div>
              ...
              <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-thin text-slate-300 leading-relaxed tracking-wide">
                ...
                <span className="word-animate" data-delay="1550">intelligence</span>
                <span className="word-animate" data-delay="1700">meets</span>
                <span className="word-animate" data-delay="1850">intuition</span>
                <span className="word-animate" data-delay="2000">and</span>
                <span className="word-animate" data-delay="2150">wisdom</span>
                <span className="word-animate" data-delay="2300">flows</span>
                <span className="word-animate" data-delay="2450">freely</span>
                <span className="word-animate" data-delay="2600">within</span>
              </div>
            </h1>
